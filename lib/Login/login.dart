          ...
          children: [
            ...
            GestureDetector(
                onTap: () async {
                  ...
                  if (!signinnavigator) {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Register(false)));
                  }
                },
            ...
            GestureDetector(
                onTap: () async {
                  ...
                  if (!registernavigate) {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Register(false)));
                  }
                },
